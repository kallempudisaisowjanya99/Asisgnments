...
if(creditScore>750)
{
console.log("Congratulations!, loan is approved")
}
...
if(income>=50000 && isEmployed){
    ...
    {
        console.log("Sorry, loan is denied3")
    }
}
else console.log("Sorry, loan is denied")
}
else if(creditScore<650)
{
console.log("Sorry, loan is denied")
}
}

let result= loneEligible()
